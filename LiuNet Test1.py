...
h_conv1 = tf.nn.leaky_relu((conv2d(x_, W_conv1) + b_conv1),alpha=0.1)
...
h_fc2 = tf.nn.leaky_relu((tf.matmul(h_fc1_drop, W_fc2) + b_fc2),alpha = 0.1)
...
for epoch in range(training_epochs):
    ...
    for batch_xs,batch_ys in generatebatch(X_train_normalized,y_train,n_train,batch_size): # run MBGD for every iteration
